...
|sort|`xxx.sort((a, b) => b.balance - a.balance)`|return Array|for Object Array|
...
|`const aa = bb(organizationId!)`|<mark>`organizationId!`</mark> === `const organizationId: string \ null`|
