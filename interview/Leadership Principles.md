...
|1) Tell me a time when you had disagreement with someone at work|![Alt text](./images/image-16.png) |
|2) Give an example of a time when you didn't see eye-to-eye with a work colleague|![Alt text](./images/image-20.png)|
|------------------------------|---------------------------------------------|
|14. Deliver Results 达成业绩|answers|
|1) describe a time when you overcame a difficult challenge at work|![Alt text](./images/image-15.png)|
|2) Give an example of a time when you went above and beyond to meet a deadline|![Alt text](./images/image-18.png)|
|------------------------------|---------------------------------------------|
