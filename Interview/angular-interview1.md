...
- [2. Explain _data-binding_ in Angular. What are the different types?](#2-explain-data-binding-in-angular-what-are-the-different-types)
  - [Key Types of Data Binding](#key-types-of-data-binding)
  - [Best Practices for Data Binding](#best-practices-for-data-binding)
  - [Code Example: Types of Data Binding](#code-example-types-of-data-binding)
- [3. Describe the _Angular application architecture_.](#3-describe-the-angular-application-architecture)
  - [Key Concepts](#key-concepts)
  - [Data Flow Mechanism: One-way Binding](#data-flow-mechanism-one-way-binding)
  - [App Structure](#app-structure)
  - [Code Example: Root Module](#code-example-root-module)
- [4. What is a _component_ in Angular and how is it used?](#4-what-is-a-component-in-angular-and-how-is-it-used)
  - [Key Component Parts](#key-component-parts)
  - [Core Concepts](#core-concepts)
  - [Unique Features](#unique-features)
    - [Component-Scoped Styles](#component-scoped-styles)
    - [Modular Design for UI Elements](#modular-design-for-ui-elements)
    - [Reusability:](#reusability)
    - [Clear Separation of Concerns:](#clear-separation-of-concerns)
  - [Code Example: Basic Angular Component](#code-example-basic-angular-component)
- [5. What are _directives_ in Angular and can you name a few commonly used ones?](#5-what-are-directives-in-angular-and-can-you-name-a-few-commonly-used-ones)
  ...
  - [Commonly Used Directives](#commonly-used-directives)
  - [Code Example: ngFor](#code-example-ngfor)
  - [Why Use Directives?](#why-use-directives)
- [6. How do you create a _service_ in Angular and why would you use one?](#6-how-do-you-create-a-service-in-angular-and-why-would-you-use-one)
  ...
  - [Code Example: Service](#code-example-service)
- [7. Can you explain what _dependency injection_ is in Angular?](#7-can-you-explain-what-dependency-injection-is-in-angular)
  ...
  - [Key Angular Features Linked to DI](#key-angular-features-linked-to-di)
  - [Code Example: DI in Angular](#code-example-di-in-angular)
- [8. What is a _module_ in Angular and what is its purpose?](#8-what-is-a-module-in-angular-and-what-is-its-purpose)
  - [Key Module Elements](#key-module-elements)
  - [Types of Modules](#types-of-modules)
  - [Advantages of Using Modules](#advantages-of-using-modules)
  - [Code Example: Module Structure](#code-example-module-structure)
...
- [10. What is _two-way binding_ and how do you implement it in Angular?](#10-what-is-two-way-binding-and-how-do-you-implement-it-in-angular)
  ...
  - [Using `[(ngModel)]` and `FormsModule`](#using-ngmodel-and-formsmodule)
  - [Using `[(ngModel)]` with `ReactiveFormsModule`](#using-ngmodel-with-reactiveformsmodule)
  - [Best Practices](#best-practices)
  - [When to Use Two-Way Binding](#when-to-use-two-way-binding)
- [11. Explain the difference between an Angular _component_ and a _directive_.](#11-explain-the-difference-between-an-angular-component-and-a-directive)
  - [Key Distinctions](#key-distinctions)
    ...
    - [Interaction with Angular Material](#interaction-with-angular-material)
...
- [12. What are _Pipes_ in Angular and where would you use them?](#12-what-are-pipes-in-angular-and-where-would-you-use-them)
  - [Core Pipe Types](#core-pipe-types)
    - [String](#string)
    - [Numeric](#numeric)
    - [Date](#date)
    - [Array](#array)
...
- [13. How do you handle _form submissions_ in Angular?](#13-how-do-you-handle-form-submissions-in-angular)
  - [Template-Driven Forms](#template-driven-forms)
    - [Steps to Use Template-Driven Forms](#steps-to-use-template-driven-forms)
    - [TypeScript Example: Implementing Template-Driven Forms](#typescript-example-implementing-template-driven-forms)
  - [Reactive Forms](#reactive-forms)
    - [Steps to Use Reactive Forms](#steps-to-use-reactive-forms)
    - [TypeScript Example: Implementing Reactive Forms](#typescript-example-implementing-reactive-forms)
  - [Code for App Module](#code-for-app-module)
- [14. What is _Angular CLI_ and what can it be used for?](#14-what-is-angular-cli-and-what-can-it-be-used-for)
  - [Key Features and Uses](#key-features-and-uses)
  - [The Angular CLI Workflow: Start to Finish](#the-angular-cli-workflow-start-to-finish)
- [15. Describe how to make _HTTP requests_ in Angular using _HttpClient_.](#15-describe-how-to-make-http-requests-in-angular-using-httpclient)
  - [Setting Up `HttpClientModule`](#setting-up-httpclientmodule)
  - [Making Simple HTTP GET Request](#making-simple-http-get-request)
  - [Handling Response](#handling-response)
    - [`get` Method with JSON Response](#get-method-with-json-response)
    - [`get` Method for Non-JSON Data](#get-method-for-non-json-data)
    - [Error Handling](#error-handling)
  - [Making Other HTTP Requests](#making-other-http-requests)
  - [Security Considerations](#security-considerations)
    - [Explore all 100 answers here 👉 Devinterview.io - Angular](#explore-all-100-answers-here--devinterviewio---angular)
