...
const ToggleThemeTestPage = () => {
  return (
    <div className="m-10 rounded-lg bg-white dark:bg-black px-6 py-8 shadow-xl ring-1 ring-slate-900/5">
      <h3 className='text-base font-medium tracking-tight text-slate-800 dark:text-white'>Write Upside-Down</h3>
