      ...
      <CardContent>
        ...
        <div className="flex gap-4 my-4">
          <form action={actions.deleteTalent}>
            ...
            <button className="bg-red-500 px-6 py-2 rounded text-white">Delete</button>
          </form>
          {/* Dialog  Edit*/}
                  ...
                  <div className="w-full gap-4 py-4">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <textarea
                        ...
                        name="skills"
                        className="w-full font-normal outline outline-0 focus:outline-0 transition-all border focus:border-2 text-sm px-3 py-2.5 rounded-[7px] border-blue-gray-200 focus:border-gray-900"></textarea>
        ...
        {/* Hire Button */}
        <Link className="bg-blue-500 px-6 py-2 rounded text-white" href={`mailto:${talentData.email}`}> Hire Me </Link>
      </CardContent>
    </Card>
  )
}
