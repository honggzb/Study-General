...
var distDir = fs.realpathSync('../html5') + path.sep + "dist_appworks";
...
exports.scan = function scan(files)
	...
	map.forEach(function(t)
		...
		extend(task['concat-imports'], t['concat-imports']);
		extend(task['concat-less'], t['concat-less']);
		});
