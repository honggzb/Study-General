        ...
        <el-tabs tab-position="right">
          ...
          <el-tab-pane>
            <div class="course-container">
              <div class="courseName" title="courseInfo.courseName">
                 course Name  <!--{{chapterInfo.chapterName}} -->
              </div>
              ...
              <div class="teacher" v-if="true">
                ...
                <div class="teacherInfo">
                  ...
                  <div class="teacherTag">teacher Tag</div>
                </div>
              </div>
          ...
          <el-tab-pane>
            ...
            <div class="chapter-container">
              ...
              <dl class="list">
                <dt title="item.chapterName">chapter1</dt> <!--{{item.chapterName}} -->
...
//import { player } from '@/utils/api/courseManage']
...
let route = useRoute()
const { cousreId, chapterId } = route.params
//当前播放课程的数据
let chapterInfo = ref({});
//课程章节 和 小节的数据
...
:deep(.el-tabs__item.is-active .tabpanel-title) {
  background: #25282a !important;
}
:deep(.el-tabs__item.is-active .tabpanel-title .icon),
:deep(.el-tabs__item.is-active .tabpanel-title .text) {
  color: #ffffff;
}
:deep(.el-tabs__nav.is-right) {
  padding: 20px 0;
