    ...
    <section>
      <div class="login-box">
        ...
        <div class="login-left">
          <a href="/" title="xxx" class="logo">
            <img src="../assets/img/logo02.png" alt="xxxx" title="xxxx" />
          </a>
          <div class="left-qrcode">
            <div id="qrcode" title="xxxx">
        ...
        <div class="login-right">
          <div class="login-form">
            <ul class="nav nav-tabs">
              <li v-for="item in loginTxt" :key="item.id"
                  class="nav-items" :class="current == item.id ? 'actives' : ''"
...
// import { loginByJson, sendCaptcha , loginByMobile } from '../api/login.ts'
...
const phoneBtn = (formEl) => {
    ...
    formEl.validate((valid, fields) => {
      if (valid) {
          //console.log( valid )
          let mobile = Encrypt(ruleFormPhone.phone);  //用户输入的手机号
          let captcha = ruleFormPhone.captcha;       //用户输入的验证码
