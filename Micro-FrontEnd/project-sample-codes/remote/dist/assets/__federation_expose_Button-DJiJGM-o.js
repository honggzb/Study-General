...
const Button = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setState((count) => count + 1), children: [
    "remote button: count is ",
    bcount
  ] }) });
};
