...
- [types of ML](#types-of-ml)
  ...
  - [no-supervised-无监督学习 ML](#no-supervised-无监督学习-ml)
  - [半监督学习](#半监督学习)
  - [强化学习](#强化学习)
...
- ![Supervised-ML](https://github.com/honggzb/Study-General/blob/master/Cloud-study/imagesSupervised-ML.png)
...
|Polynomial regression|regression equation|
 |power o independent variable greater than 1|
