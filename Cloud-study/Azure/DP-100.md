...
![Azure-ML-workspace1](https://github.com/honggzb/Study-General/tree/master/Cloud-study/images/Azure-ML-workspace1.png)
![Azure-ML-workspace2](https://github.com/honggzb/Study-General/tree/master/Cloud-study/images/Azure-ML-workspace2.png)
...
- create a pipeline
  - using YAML file
  - using `@pipeline()`
  - ![pipeline-built](https://github.com/honggzb/Study-General/tree/master/Cloud-study/images/pipeline-built.png)
- run a pipeline job
