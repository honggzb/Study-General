...
Azure Factory     | Control data movement between stores    |  Public to Azure SQL data warehouse
...
| |Multi-factore authentication | |Shared key to secure transfer|
...
|------------------|-----------------------------------|------------------|------------------------------------|
| |Encryption | |  |
|Azure databricks |Secure Shell(SSH) | |  |
...
|---|---|---|---|
| | | | Azure Data Factory|
|Azure SQL DB | |Azure Cosmos DB |Azure Cosmos DB API|
| | | |JSON|
| | | | Direct editing|
|------------------|------------------------------------|------------------|------------------------------------|
| |AzCopy | | Apache sqoop|
...
|Azure HDInsight |Hive for ETL operations | |Route job output |
