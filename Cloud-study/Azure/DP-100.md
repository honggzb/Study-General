...
|---|---|---|---|
|Affinity Propagation|![Affinity Propagation](Affinity-Propagation.png) |Agglomerative|![Agglomerative](Agglomerative.png) |
|BIRCH(Balanced Iterative Reducing and Clustering using Hierachies Model)|![BIRCH](BIRCH.png)|DBSCAN(Density-Based Spatial Clustering of Applications with Noise)|![DBSCAN](DBSCAN.png)|
|K-Means|![K-Means](K-Means.png)|Mean Shift|![Mean Shift](Mean-Shift.png)|
|OPTICS(Ordering Points to Identify the Clustering Struture)|![OPTICS](OPTICS.png)|Caussian Mixture|![Caussian Mixture](Caussian-Mixture.png)|
