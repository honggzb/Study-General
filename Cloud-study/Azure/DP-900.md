...
- Data Factory Components
  ...
  - Integration Runtimes: ADF(Angular Distribution Functions) compute engine
...
- Other ETL Options
  ...
  - PolyBase
    ...
    - Enables u to run SQL commands on external data(e.g. Azure Data Lakes, Blob storage, Hadoop...)
  - Azure Data Lake
    ...
    - Azure Data Lake Storage
      ...
      - ADLS Gen2 is a superset of Blob storage(enable "hierarchical Namespace" at storage provision)
      - Two advantages ove Blob:
  ...
  - Azure Databricks
    - Advanced Anaylytics and ML platform based on Apache Spark
